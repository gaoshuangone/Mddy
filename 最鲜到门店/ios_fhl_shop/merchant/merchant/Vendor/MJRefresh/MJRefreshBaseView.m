...
{
    if (!_arrowImage) {
        UIImageView *arrowImage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:MJRefreshSrcName(@"arr.png")]];
...
- (void)layoutSubviews
{
    ...
    self.arrowImage.center = CGPointMake(iPhone6?arrowX+WINDOW_WIDTH/2-58-30:iPhone6Plus?arrowX+WINDOW_WIDTH/2-58-48: arrowX+WINDOW_WIDTH/2-58 , self.mj_height * 0.5);
