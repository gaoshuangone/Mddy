...
@interface OrderQianShouTableViewCell : TableViewCellValue
@property (weak, nonatomic) IBOutlet UILabel *labelJInE;
@property (weak, nonatomic) IBOutlet UILabel *labelTime;
@property (weak, nonatomic) IBOutlet UILabel *labelPeiSongYuan;

@property (weak, nonatomic) IBOutlet UILabel *labelPeiSongFei;
@property (weak, nonatomic) IBOutlet UIImageView *imageViewOrderType;
@property (weak, nonatomic) IBOutlet UIImageView *imageViewPeiSongDengJi;
@property (weak, nonatomic) IBOutlet UILabel *labelShouHuoAddress;
@property (weak, nonatomic) IBOutlet UIButton *buttonPhonePressed;
